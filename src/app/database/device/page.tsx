          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-4 gap-4">
              <div className="col-span-1">
                <h2 className="text-base text-gray-900">企業名/Client</h2>
              ...
              <div className="col-span-1">
                <h2 className="text-base text-gray-900">責任者/Director</h2>
              ...
              <div className="col-span-1">
                <h2 className="text-base text-gray-900">設備名/System Name</h2>
              ...
              <div className="col-span-1">
                <h2 className="text-base text-gray-900">装置名/Device Name</h2>
