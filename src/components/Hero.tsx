    ...
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-green-400 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-green-600">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute left-0 top-2/3 h-[0.58em] w-full fill-yellow-300"
      ...
      <div className="mt-36 lg:mt-44">
        <p className="font-display text-base text-slate-900 dark:text-slate-200">
            Created by the KDX Project in 2024
        </p>
      </div>
    </Container>
  )
