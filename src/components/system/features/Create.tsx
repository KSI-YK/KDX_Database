      ...
      <div className="space-y-4">
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto">
            <div className="border-b border-gray-300 pb-4 pt-4 dark:border-gray-500">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-4 gap-4">
            ...
            <div className="col-span-3">
              <Select
                className="basic-single rounded-md bg-slate-800 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 dark:bg-slate-800 sm:text-sm sm:leading-6"
            ...
            <div className="col-span-3">
              <Select
                className="basic-single rounded-md text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 dark:bg-slate-800 sm:text-sm sm:leading-6"
                classNamePrefix="select"
                isSearchable={true}
                name="director"
                options={userOptions}
