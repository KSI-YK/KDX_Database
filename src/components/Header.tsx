...
const projects = [
  { name: 'クライアント管理', description: '客先情報の追加、変更', href: '/client', icon: BuildingOffice2Icon },
  { name: 'プロジェクト管理', description: 'プロジェクト・作番情報の追加、変更、進捗管理', href: '#', icon: BriefcaseIcon },
  { name: 'タスク管理', description: 'タスク・出張情報の追加、変更、進捗管理', href: '#', icon: QueueListIcon },
